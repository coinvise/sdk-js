...
interface Erc721Interface extends ethers.utils.Interface {
  functions: {
    ...
    "bulkMintTo(uint256,string,address)": FunctionFragment
  ...
  encodeFunctionData(functionFragment: "bulkMintTo", values: [BigNumberish, string, string]): string
  encodeFunctionData(
...
export class Erc721 extends BaseContract {
  ...
  callStatic: {
    ...
    bulkMintTo(_amount: BigNumberish, _tokenId: string, _finalOwner: string, overrides?: CallOverrides): Promise<void>
