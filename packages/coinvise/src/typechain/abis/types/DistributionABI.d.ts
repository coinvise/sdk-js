...
interface DistributionABIInterface extends ethers.utils.Interface {
  functions: {
    "claim(address,uint256,uint8,bytes32,bytes32)": FunctionFragment
...
export class DistributionABI extends BaseContract {
  ...
  interface: DistributionABIInterface
