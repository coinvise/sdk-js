...
export class HTTPResponseError extends Error {
  readonly code: string = 'coinvise_response_error';
  ...
  constructor(response: GotResponse, message?: string) {
    super(
      message ??
        `Request to Coinvise API failed with status: ${response.statusCode}`
    );
...
export class RequestTimeoutError extends Error {
  readonly code = 'coinvise_response_error';

  constructor(message = 'Request to Coinise API has timed out') {
    super(message);
